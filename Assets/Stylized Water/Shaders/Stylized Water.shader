    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            float4 frag (v2f i) : SV_Target
            {
                ...
                float3 baseColor = fragColor * _ShallowColor.rgb;
                baseColor = lerp(_DeepColor.rgb, baseColor, transmittance * max(0.5, shadowMask));
                baseColor = lerp(_FarColor.rgb, baseColor, distanceMask);
                ...
                float3 sssColor = _SSSColor.rgb * GetWaveHeight(i.worldPosition.xz);
                ...
                float3 sunSpecularColor = lerp(0, _SunSpecularColor.rgb, sunSpecularMask);
                ...
                float3 sparkleColor = lerp(0, _SparkleColor.rgb, sparkleMask);
                ...
                float3 edgeFoamColor = lerp(0, _EdgeFoamColor.rgb, edgeFoamMask);
                edgeFoamColor = edgeFoamColor * lerp(_ShadowColor.rgb, 1, shadowMask);
